    ...
    description: (
      <>
        <p>
          ...
          <ProseLink href="http://www.cs.columbia.edu/~sedwards/classes/2024/4840-spring/index.html" external>Embedded Systems</ProseLink>
        ...
        <p>
          ...
          <ProseLink href="https://en.wikipedia.org/wiki/Phase_vocoder" external>Phase Vocoder</ProseLink>
          ...
          <ProseLink href="https://github.com/sanjayrajasekharan/pitch-perfect" external>here</ProseLink>
          {` and our final presentation slides `}
          <ProseLink href="http://www.cs.columbia.edu/~sedwards/classes/2024/4840-spring/reports/Harmony-Hand-presentation.pdf" external>here</ProseLink>
          {`.`}
        </p>
      </>
    ),
    ...
    description: (
      <>
        ...
        <p>
          ...
          <ProseLink href="/waves" external>here</ProseLink>
    ...
    description: (
      <>
        <p>
          ...
          <ProseLink href="https://www.scte.org/standards/library/catalog/scte-35-digital-program-insertion-cueing-message/" external>SCTE-35 standard</ProseLink>
    ...
    description: (
      <>
        ...
        <p>
          ...
          <ProseLink href="/projects#rhymenet" external>RhymeNet</ProseLink>
          ...
          <ProseLink href="https://github.com/stevenwinnick/SyllableGPT" external>here</ProseLink>
          {`.`}
        </p>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="http://www.speech.cs.cmu.edu/cgi-bin/cmudict" external>CMU Pronouncing Dictionary</ProseLink>
        ...
        <ProseLink href="https://www.tandfonline.com/doi/abs/10.1080/00437956.1978.11435661" external>{`"greedy onset clustering"`}</ProseLink>
        ...
        <ProseLink href="https://github.com/stevenwinnick/RhymeNet" external>here</ProseLink>
        {`.`}
      </p>
    ),
  },
  {
    ...
    subtitle: (
      <>
        ...
        <ProseLink href="https://www.linkedin.com/in/adam-strupp-51b82319a/" external>Adam</ProseLink>
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://en.wikipedia.org/wiki/Sheepshead_(card_game)" external>Sheepshead,</ProseLink>
        ...
        <ProseLink href="https://github.com/stevenwinnick/Sheepshead" external>here</ProseLink>
        {`.`}
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://github.com/stevenwinnick/SessionViewMIDI" external>here</ProseLink>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://www.linkedin.com/in/yuting-li-3a0244220" external>Rex Li</ProseLink>
        ...
        <ProseLink href="https://en.wikipedia.org/wiki/Inverse_kinematics#Numerical_solutions_to_IK_problems" external>math</ProseLink>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://github.com/stevenwinnick/DeepLearningNeuralNetworkFromScratch" external>here</ProseLink>
        {`.`}
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://www.paramount.com" external>Paramount</ProseLink>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://www.sonarhealth.co" external>Sonar</ProseLink>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <ProseLink href="https://getbootstrap.com/docs/5.2/getting-started/introduction/" external>Bootstrap 5</ProseLink>
        ...
        <ProseLink href="/contact">contact</ProseLink>
