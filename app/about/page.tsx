...
export default function AboutPage() {
  return (
    <section className="page-grid gap-y-line pb-2line">
      ...
      {/*
       * Subgrid so the photos and the copy sit on the page grid's columns: the
       * photos flank the copy in the outer columns from `cols4`, and above it
       * below that, where those columns do not exist. The second photo is
